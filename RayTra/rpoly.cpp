...
//
// To distinguish the routines posted below from others, an  suffix has been appended to them.
//
...
int main()
{
	...
	cout << "been saved beforehand in a file named rpolydat.txt.\n";
	cout << "rpolydat.txt should be in the same folder as the rpoly executable. \n";
	cout << "--------------------------------------------------------------------------- \n";
	...
	cout << "http://www.akiti.ca/rpoly_Intro.html\n";
	cout << "--------------------------------------------------------------------------- \n";
